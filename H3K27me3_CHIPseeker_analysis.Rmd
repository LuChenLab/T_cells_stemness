...
files <- list(`10+MET-1` = "../09.CHIPseeker/10+MET-1_macs2_peaks_CHIPseeker.bed",
                ...
                `CON-1` = "../09.CHIPseeker/CON-1_macs2_peaks_CHIPseeker.bed",
                `CON-2` = "../09.CHIPseeker/CON-2_macs2_peaks_CHIPseeker.bed" )
myPeaks <- GenomicRanges::GRangesList(`10+MET-1` = readPeakFile(files[[1]]),
                ...
                `CON-1` = readPeakFile(files[[5]]),
                `CON-2` = readPeakFile(files[[6]]) )
...
pdf("../09.CHIPseeker/K27me3_anno_barplot.pdf", width = 5, height = 3)
p_barplot
...
write.xlsx(peakAnnoList_df,file='./09.CHIPseeker/K27me3_anno_peak.xlsx',
